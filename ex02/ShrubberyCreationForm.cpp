...
/*   Updated: 2025/03/31 19:57:02 by paprzyby         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ShrubberyCreationForm::ShrubberyCreationForm(const std::string &target) : AForm("Default ShrubberyCreationForm name", 145, 137), target(target)	{}
